    ...
    <>
      ...
      <div className="flex-1 flex flex-col items-center px-4" style={{ paddingTop: '7vh' }}>
        ...
        <div className="w-full" style={{ maxWidth: 390 }}>
          <div className="bg-transparent flex items-center" style={{ height: 65, borderRadius: 20, padding: '0 16px', marginBottom: 12, border: '1px solid rgba(255,255,255,0.15)' }}>
            <input
              type="text"
              ...
              style={{ fontFamily: FONT, marginTop: -16 }}
            />
          </div>
      ...
      {/* Meta Logo Footer */}
      <div className="absolute left-0 right-0 flex justify-center" style={{ bottom: 36 }}>
