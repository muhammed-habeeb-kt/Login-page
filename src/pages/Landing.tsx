    ...
    <>
      ...
      <div className="absolute left-0 right-0 flex justify-center items-center gap-[6px]" style={{ bottom: 20 }}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="24" height="24">
          <path fill="#DFE6ED" d="M400 128c-29.3 0-55.6 13.9-72.3 35.5c-20.7 26.8-43.2 64-67.7 104.3c-24.5-40.3-47-77.5-67.7-104.3C175.6 141.9 149.3 128 120 128C53.7 128 0 181.7 0 248s53.7 120 120 120c29.3 0 55.6-13.9 72.3-35.5c20.7-26.8 43.2-64 67.7-104.3c24.5 40.3 47 77.5 67.7 104.3c16.7 21.6 43 35.5 72.3 35.5c66.3 0 120-53.7 120-120s-53.7-120-120-120zm0 176c-13.1 0-25-6.6-32.2-17.7c-17.4-26.6-38.1-61.9-61.2-102.2c-15.5-27-31.5-54.6-46.6-76.1c11.1-12.2 26.8-20 44.4-20c35.3 0 64 28.7 64 64s-28.7 64-64 64zm-280 0c-35.3 0-64-28.7-64-64s28.7-64 64-64c17.6 0 33.3 7.8 44.4 20c-15.1 21.5-31.1 49.1-46.6 76.1c-23.1 40.3-43.8 75.6-61.2 102.2c-7.2 11.1-19.1 17.7-32.2 17.7z" />
        </svg>
        <span className="text-[#DFE6ED] text-[16px] font-bold tracking-tight" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
          Meta
        </span>
      </div>
    </>
