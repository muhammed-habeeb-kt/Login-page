    ...
    <>
      ...
      <div className="flex-1 flex flex-col items-center px-4" style={{ paddingTop: '7vh' }}>
        ...
        <div className="w-full" style={{ maxWidth: 390 }}>
          <div className="bg-transparent flex items-center" style={{ height: 65, borderRadius: 7, padding: '0 16px', marginBottom: 12, border: '1px solid rgba(255,255,255,0.15)' }}>
            <input
              type="text"
          ...
          <div className="bg-transparent flex items-center" style={{ height: 65, borderRadius: 7, padding: '0 16px', border: '1px solid rgba(255,255,255,0.15)' }}>
            <input
              type="password"
