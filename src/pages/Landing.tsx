    ...
    <>
      ...
      <div className="flex-1 flex flex-col items-center px-6" style={{ paddingTop: '7vh' }}>
        ...
        <div className="w-full" style={{ maxWidth: 350 }}>
          <div className="bg-transparent flex items-center" style={{ height: 63, borderRadius: 10, padding: '0 16px', marginBottom: 12, border: '1px solid rgba(255,255,255,0.15)' }}>
            <input
              type="text"
          ...
          <div className="bg-transparent flex items-center" style={{ height: 63, borderRadius: 10, padding: '0 16px', border: '1px solid rgba(255,255,255,0.15)' }}>
            <input
              type="password"
        ...
        <div className="w-full mt-4" style={{ maxWidth: 350 }}>
          <button
            ...
            style={{ height: 63, borderRadius: 26, fontFamily: FONT }}
          >
            Next
          </button>
        </div>
